...
Меня зовут **Андрей**, я Product Manager. Этот репозиторий — мой личный инструмент в поиске работы: собрал для себя, выложил сюда, чтобы делиться с друзьями и коллегами.
...
Привет ещё раз — я **Андрей Накимов**, Product Manager в B2B SaaS и маркетплейсах.
